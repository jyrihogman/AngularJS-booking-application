class CalendarController {
    ...
    constructor () {
        ...
        this.buildMonth(this.selected, start, this.month);
    }
    ...
    next() {
        ...
        this.buildMonth(this.selected, next, this.month);
    }
    ...
    previous() {
        ...
        this.month.month(this.month.month() - 1);
        this.buildMonth(this.selected, previous, this.month);
    }
    ...
    buildMonth(selected, start, month) {
        this.weeks = [];
